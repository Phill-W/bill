...
export const reimCompanyOptions = [
  {
  ...
  {
    reimCompanyId: '16AE93CC7EF92002',
    reimCompanyNo: '0411',
    reimCompanyName: '胜意科技荆州分公司',
  },
]
...
export const departmentOptions = [
  ...
  },
  {
    ...
    reimDepartmentNo: '072005',
    reimDepartmentName: '航旅事业部',
  },
  {
...
export const businessTypeOptions = [
  ...
  {
    businessTypeId: '18F091913EEC4000',
    businessTypeNo: '100100101',
    businessTypeName: '境内出差',
    thereSubordinateNode: '1',
  ...
  {
    businessTypeId: '13AB3A4138008001',
    businessTypeNo: '100100102',
    businessTypeName: '境外出差',
    thereSubordinateNode: '1',
    superiorId: '18F0916A8C2C4000',
  },
  {
    businessTypeId: '13AB3A4248008002',
    businessTypeNo: '10010010201',
    businessTypeName: '国外考察',
    thereSubordinateNode: '0',
    superiorId: '13AB3A4138008001',
  },
  {
  ...
  {
    businessTypeId: '13AB3A4172008001',
    businessTypeNo: '1001002',
    businessTypeName: '人力资源',
    thereSubordinateNode: '1',
    superiorId: 'none',
  },
  {
    businessTypeId: '13AB3A418F808001',
    businessTypeNo: '100100201',
    businessTypeName: '个人团队培训',
    thereSubordinateNode: '0',
    superiorId: '13AB3A4172008001',
  },
  {
    businessTypeId: '13AB3A41AC408001',
    businessTypeNo: '100100202',
    businessTypeName: '招聘会',
    thereSubordinateNode: '0',
    superiorId: '13AB3A4172008001',
  },
  {
    businessTypeId: '13AB3A41CD808002',
    businessTypeNo: '1001003',
    businessTypeName: '员工福利',
    thereSubordinateNode: '1',
    superiorId: 'none',
  },
  {
    businessTypeId: '13AB3A41ED408002',
    businessTypeNo: '100100301',
    businessTypeName: '员工旅游',
    thereSubordinateNode: '0',
    superiorId: '13AB3A41CD808002',
  },
  {
    businessTypeId: '13AB3A420CC08002',
    businessTypeNo: '100100302',
    businessTypeName: '员工团建',
    thereSubordinateNode: '0',
    superiorId: '13AB3A41CD808002',
  },
  {
    businessTypeId: '13AB3A422A808001',
    businessTypeNo: '100100303',
    businessTypeName: '员工体检',
    thereSubordinateNode: '0',
    superiorId: '13AB3A41CD808002',
  },
]
...
export const projectOptions = [
  ...
  {
    projectId: '1C5931735AC4A000',
    projectNo: 'southChina',
    projectName: '华南客户定制化项目',
  },
  {
    projectId: '1771EC45F2443000',
    projectNo: 'northChina',
    projectName: '华北客户定制化项目',
  },
  {
  ...
  {
    projectId: '17071065FC29A002',
    projectNo: 'southWest',
    projectName: '西南客户定制化项目',
  },
  {
    projectId: '162664EBE9ABE001',
    projectNo: 'northWest',
    projectName: '西北客户定制化项目',
  },
  {
    projectId: '162664B8526BE002',
    projectNo: 'northEast',
    projectName: '东北客户定制化项目',
  },
]

export function buildBusinessTypeTree(list = businessTypeOptions): SelectOptionNode[] {
  const map = new Map<string, SelectOptionNode>()
  const roots: SelectOptionNode[] = []

  list.forEach((item) => {
    map.set(item.businessTypeId, {
      label: item.businessTypeName,
      value: item.businessTypeId,
      businessTypeNo: item.businessTypeNo,
  ...
  list.forEach((item) => {
    ...
    if (!node) return
    if (item.superiorId === 'none') {
      roots.push(node)
    } else {
      map.get(item.superiorId)?.children?.push(node)
    }
  })
